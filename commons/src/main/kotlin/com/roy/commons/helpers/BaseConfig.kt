...
import com.roy.commons.ext.getInternalStoragePath
import com.roy.commons.ext.getSDCardPath
import com.roy.commons.ext.getSharedPrefs
...
open class BaseConfig(val context: Context) {
    ...
    var backgroundColor: Int
        get() = prefs.getInt(
            BACKGROUND_COLOR,
            context.resources.getColor(R.color.default_background_color2)
        )
