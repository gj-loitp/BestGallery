...
import com.roy.commons.ext.getDirectChildrenCount
import com.roy.commons.ext.getDuration
import com.roy.commons.ext.getFileAlbum
import com.roy.commons.ext.getFileArtist
import com.roy.commons.ext.getFileCount
import com.roy.commons.ext.getFileDurationSeconds
import com.roy.commons.ext.getFileSongTitle
import com.roy.commons.ext.getImageResolution
import com.roy.commons.ext.getParentPath
import com.roy.commons.ext.getProperSize
...
import com.roy.commons.helpers.SORT_BY_EXTENSION
...
open class FileDirItem(
    ...
    override fun toString() =
        "FileDirItem(path=$path, name=$name, isDirectory=$isDirectory, children=$children, size=$size)"
        ...
        return if (isDirectory && !other.isDirectory) {
            ...
            when {
                ...
                sorting and SORT_BY_DATE_MODIFIED != 0 -> {
                    ...
                    result =
                        getExtension().lowercase(Locale.getDefault())
    ...
    fun getDirectChildrenCount(countHiddenItems: Boolean) =
