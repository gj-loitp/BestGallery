...
import com.roy.commons.helpers.ALARM_SOUND_TYPE_NOTIFICATION
import com.roy.commons.helpers.BaseConfig
import com.roy.commons.helpers.DAY_SECONDS
import com.roy.commons.helpers.FRIDAY_BIT
import com.roy.commons.helpers.HOUR_SECONDS
import com.roy.commons.helpers.MINUTE_SECONDS
import com.roy.commons.helpers.MONDAY_BIT
import com.roy.commons.helpers.MONTH_SECONDS
import com.roy.commons.helpers.MyContentProvider
import com.roy.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.roy.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.roy.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.roy.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.roy.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.roy.commons.helpers.PERMISSION_CALL_PHONE
import com.roy.commons.helpers.PERMISSION_CAMERA
import com.roy.commons.helpers.PERMISSION_GET_ACCOUNTS
import com.roy.commons.helpers.PERMISSION_READ_CALENDAR
import com.roy.commons.helpers.PERMISSION_READ_CALL_LOG
import com.roy.commons.helpers.PERMISSION_READ_CONTACTS
import com.roy.commons.helpers.PERMISSION_READ_STORAGE
import com.roy.commons.helpers.PERMISSION_RECORD_AUDIO
import com.roy.commons.helpers.PERMISSION_WRITE_CALENDAR
import com.roy.commons.helpers.PERMISSION_WRITE_CALL_LOG
import com.roy.commons.helpers.PERMISSION_WRITE_CONTACTS
import com.roy.commons.helpers.PERMISSION_WRITE_STORAGE
import com.roy.commons.helpers.PREFS_KEY
import com.roy.commons.helpers.SATURDAY_BIT
import com.roy.commons.helpers.SUNDAY_BIT
import com.roy.commons.helpers.THURSDAY_BIT
import com.roy.commons.helpers.TIME_FORMAT_12
import com.roy.commons.helpers.TIME_FORMAT_24
import com.roy.commons.helpers.TUESDAY_BIT
import com.roy.commons.helpers.WEDNESDAY_BIT
import com.roy.commons.helpers.WEEK_SECONDS
import com.roy.commons.helpers.YEAR_SECONDS
import com.roy.commons.helpers.appIconColorStrings
import com.roy.commons.helpers.isMarshmallowPlus
import com.roy.commons.helpers.isNougatPlus
import com.roy.commons.helpers.isOnMainThread
import com.roy.commons.helpers.proPackages
import com.roy.commons.models.AlarmSound
import com.roy.commons.models.SharedTheme
import com.roy.commons.views.MyAppCompatCheckbox
import com.roy.commons.views.MyAppCompatSpinner
import com.roy.commons.views.MyButton
import com.roy.commons.views.MyCompatRadioButton
import com.roy.commons.views.MyEditText
import com.roy.commons.views.MyFloatingActionButton
import com.roy.commons.views.MySeekBar
import com.roy.commons.views.MySwitchCompat
import com.roy.commons.views.MyTextView
...
fun Context.toast(msg: String, length: Int = Toast.LENGTH_SHORT) {
    try {
        if (isOnMainThread()) {
            ToastCompat.makeText(applicationContext, msg, length).show()
        } else {
