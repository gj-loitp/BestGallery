package com.roy.gallery.pro.utils;
...
public class Preferences {
    ...
    public static int getInt(@StringRes final int keyStringResId, @IntegerRes final int defaultIntResId) {
        final Resources r = App.mContext.getResources();
    ...
    private synchronized static SharedPreferences read() {
        ...
        if (dirty || cache == null) {
            res = PreferenceManager.getDefaultSharedPreferences(App.mContext);
            dirty = false;
