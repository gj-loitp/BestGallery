...
class SettingsActivity : com.eagle.gallery.pro.activities.SimpleActivity() {
    ...
    private fun setupManageIncludedFolders() {
        settings_manage_included_folders_holder.setOnClickListener {
            startActivity(Intent(this, com.eagle.gallery.pro.activities.IncludedFoldersActivity::class.java))
        }
    }

    private fun setupManageExcludedFolders() {
        settings_manage_excluded_folders_holder.setOnClickListener {
            startActivity(Intent(this, com.eagle.gallery.pro.activities.ExcludedFoldersActivity::class.java))
        }
    }
    ...
    private fun setupManageHiddenFolders() {
        settings_manage_hidden_folders_holder.setOnClickListener {
            handleHiddenFolderPasswordProtection {
                startActivity(Intent(this, com.eagle.gallery.pro.activities.HiddenFoldersActivity::class.java))
            }
        }
    }
