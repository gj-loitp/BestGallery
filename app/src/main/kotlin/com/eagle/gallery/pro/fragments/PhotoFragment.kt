...
class PhotoFragment : ViewPagerFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        storeStateVariables()
        if (!mIsFragmentVisible && activity is com.eagle.gallery.pro.activities.PhotoActivity) {
    ...
    private fun openPanorama() {
        Intent(context, com.eagle.gallery.pro.activities.PanoramaPhotoActivity::class.java).apply {
