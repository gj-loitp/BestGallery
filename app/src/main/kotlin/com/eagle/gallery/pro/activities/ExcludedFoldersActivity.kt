...
class ExcludedFoldersActivity : com.eagle.gallery.pro.activities.SimpleActivity(), RefreshRecyclerViewListener {
    ...
    private fun updateFolders() {
        ...
        val adapter = com.eagle.gallery.pro.adapters.ManageFoldersAdapter(this, folders, true, this, manage_folders_list) {}
